...
| E4-S2 | Fork fallback, SARIF option, docs | done |
...
| E6-S2 | Approval annotation, errors, attribution, golden corpus | done |
...
| E8-S3 | Registry, convert, docs, README quickstart | done |
...
| E11-S2 | Flag, config key, docs | done |
